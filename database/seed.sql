...
('Vodafone Cash', '01062453344', 'manual', true, 1, 'فوري'),
...
('محمد سعد الغامدي', 'صاحب متجر إلكتروني', 'متجر التقنية', 5, 'ساعدوني في فتح حساب Payoneer وكانت العملية سلسة جداً. الآن أستطيع استقبال المدفوعات من العملاء الأجانب بسهولة.', false, true, 5, true),
...
('ما هي أوقات العمل؟', 'نحن نعمل على مدار 24 ساعة طوال أيام الأسبوع. فريق الدعم الفني متاح دائماً للرد على استفساراتكم ومساعدتكم في أي وقت.', 'general', 7, true, 'ar'),
