...
('Skrill', 'إنشاء وتفعيل محفظة Skrill الرقمية', '20$', 'wallets', '["محفظة آمنة", "تحويلات سريعة", "رسوم منخفضة"]', 3, true, false, '3 دقائق'),
...
('Bybit', 'إنشاء حساب Bybit للتداول', '20$', 'crypto', '["منصة تداول", "أدو��ت متقدمة", "دعم فني"]', 9, true, false, '5 دقائق'),
...
('Vodafone Cash', '+966501234567', 'manual', true, 1, 'فوري'),
...
('محمد سعد ال��امدي', 'صاحب متجر إلكتروني', 'متجر التقنية', 5, 'ساعدوني في فتح حساب Payoneer وكانت العملية سلسة جداً. الآن أستطيع استقبال المدفوعات من العملاء الأجانب بسهولة.', false, true, 5, true),
...
('ما هي أوقات العمل؟', 'نحن نعمل على مدار 24 ساعة طوال أيام الأسبو��. فريق الدعم الفني متاح دائماً للرد على استفساراتكم ومساعدتكم في أي وقت.', 'general', 7, true, 'ar'),
